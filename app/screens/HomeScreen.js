...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#FFEEDB', // Um tom bege claro similar ao da imagem
  },
  header: {
    flexDirection: 'row',
    ...
    paddingBottom: 10,
    backgroundColor: '#4B3B56', // Roxo escuro similar
  },
  headerCenterContent: {
    alignItems: 'center',
  },
  ...
  bottomNav: {
    ...
    backgroundColor: '#4B3B56', // Roxo mais escuro para a barra inferior
  },
  navItem: {
    alignItems: 'center',
  },
